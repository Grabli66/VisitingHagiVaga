// Auto-generated
let project = new Project('HuggyAnim_1_0_0');
...
project.addParameter('arm.node.MyNodeTree');
project.addParameter("--macro keep('arm.node.MyNodeTree')");
project.addShaders("build_HuggyAnim/compiled/Shaders/*.glsl", { noembed: false});
project.addShaders("build_HuggyAnim/compiled/Hlsl/*.glsl", { noprocessing: true, noembed: false });
project.addAssets("build_HuggyAnim/compiled/Assets/**", { notinlist: true });
project.addAssets("build_HuggyAnim/compiled/Shaders/*.arm", { notinlist: true });

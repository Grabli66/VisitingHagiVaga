...
project.addParameter('arm.node.FollowNode');
project.addParameter("--macro keep('arm.node.FollowNode')");
project.addParameter('arm.node.MonsterAnimation');
project.addParameter("--macro keep('arm.node.MonsterAnimation')");

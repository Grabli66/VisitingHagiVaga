// Auto-generated
let project = new Project('Game_1_0_65');
...
project.addAssets("C:/Workspace/armsdk/lib/haxebullet/ammo/ammo.js", { notinlist: true });
...
project.addParameter('arm.SyncWithParent');
project.addParameter("--macro keep('arm.SyncWithParent')");
project.addParameter('arm.MenuCanvasLogic');
project.addParameter("--macro keep('arm.MenuCanvasLogic')");
...
project.addParameter('arm.DoorOpenTrigger');
project.addParameter("--macro keep('arm.DoorOpenTrigger')");
...
project.addParameter('arm.PickLogic');
project.addParameter("--macro keep('arm.PickLogic')");
project.addParameter('arm.EntryDoorLogic');
project.addParameter("--macro keep('arm.EntryDoorLogic')");
project.addParameter('arm.GameMasterLogic');
project.addParameter("--macro keep('arm.GameMasterLogic')");
...
project.addAssets("Art/Key.png", { notinlist: true });
project.addAssets("Art/Loading.png", { notinlist: true });
project.addAssets("Art/Menu/House2.png", { notinlist: true });
project.addAssets("Art/Menu/WithHuggy.png", { notinlist: true });
...
project.addAssets("Art/Roboto-Regular.ttf", { notinlist: false });
project.addAssets("Art/StartGame.png", { notinlist: true });
project.addAssets("Art/Win.png", { notinlist: true });
project.addAssets("Art/story.png", { notinlist: true });
...
project.addAssets("Bundled/canvas/MenuCanvas.files", { notinlist: true });
project.addAssets("Bundled/canvas/MenuCanvas.json", { notinlist: true });
...
project.addAssets("C:/Workspace/VisitingHagiVaga/Art/oboi2.jpg", { notinlist: true });
project.addAssets("C:/Workspace/VisitingHagiVaga/Art/wood.jpg", { notinlist: true });
project.addAssets("C:/Workspace/VisitingHagiVaga/Art/wood2.jpg", { notinlist: true });
project.addAssets("C:/Workspace/VisitingHagiVaga/Art/СообщенияНаДвери/Message1.png", { notinlist: true });
project.addAssets("C:/Workspace/VisitingHagiVaga/Art/СообщенияНаДвери/Message10.png", { notinlist: true });
project.addAssets("C:/Workspace/VisitingHagiVaga/Art/СообщенияНаДвери/Message2.png", { notinlist: true });
project.addAssets("C:/Workspace/VisitingHagiVaga/Art/СообщенияНаДвери/Message3.png", { notinlist: true });
project.addAssets("C:/Workspace/VisitingHagiVaga/Art/СообщенияНаДвери/Message4.png", { notinlist: true });
project.addAssets("C:/Workspace/VisitingHagiVaga/Art/СообщенияНаДвери/Message5.png", { notinlist: true });
project.addAssets("C:/Workspace/VisitingHagiVaga/Art/СообщенияНаДвери/Message6.png", { notinlist: true });
project.addAssets("C:/Workspace/VisitingHagiVaga/Art/СообщенияНаДвери/Message7.png", { notinlist: true });
project.addAssets("C:/Workspace/VisitingHagiVaga/Art/СообщенияНаДвери/Message8.png", { notinlist: true });
project.addAssets("C:/Workspace/VisitingHagiVaga/Art/СообщенияНаДвери/Message9.png", { notinlist: true });

...
@:access(armory.logicnode.LogicNode)@:keep class PlayerAnim extends armory.logicnode.LogicTree {
	...
	override public function add() {
		...
		armory.logicnode.LogicNode.addLink(new armory.logicnode.ObjectNode(this, "Policeman"), _PlayActionFrom, 0, 1);
		armory.logicnode.LogicNode.addLink(new armory.logicnode.StringNode(this, "Idle_Policeman"), _PlayActionFrom, 0, 2);
